...
ssh -i "$HOME/.ssh/id_rsa_rutgers_cloudlab" $REMOTE 'cd /users/hl1276/ && yes | git clone https://github.com/0xDkXy/cloudlab-init.git && cd cloudlab-init && ./install-pkgs.sh && ./init.sh'
